...
internal class VivoxCoreInstance {
  ...
  public static int vx_get_audio_clipping_protector_parameters(float[] minimum_threshold_db, float[] threshold_boost_slope) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_audio_clipping_protector_parameters(minimum_threshold_db, threshold_boost_slope);
    return ret;
  }
