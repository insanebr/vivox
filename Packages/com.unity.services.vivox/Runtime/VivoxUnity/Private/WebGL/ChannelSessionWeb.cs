...
namespace Unity.Services.Vivox
{
    internal class ChannelSessionWeb : IChannelSession
    {
        ...
        private static extern void vx_setupLoginChannelSessionCallbacks(SimpleIntCallback onSessionEstablished,
            SimpleIntCallback onChannelSessionRemoved,
            SimpleIntCallback onRemoteStream, PointerCallback onParticipantAdded, PointerCallback onParticipantUpdated,
            PointerCallback onParticipantRemoved, PointerCallback onChannelTextMessage,
            SimpleIntCallback onSessionTerminated);
