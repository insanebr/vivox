...
namespace Unity.Services.Vivox.Mint.Default
{
    ...
    internal class ConnectTokenV1Request : DefaultApiBaseRequest
    {
        ...
        [Preserve]
        public ConnectTokenV1Request(string environmentId, string projectId, string playerId)
        {
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/players/{playerId}/connect";
    ...
    /// <summary>
    /// JoinChannelV1Request
    /// This route verifies that a UAS token passed entitlement and sanction checks in UGG
    /// </summary>
    [Preserve]
    internal class JoinChannelV1Request : DefaultApiBaseRequest
    {
        /// <summary>Accessor for environmentId </summary>
        [Preserve]
        public string EnvironmentId { get; }
        ...
        [Preserve]
        public string PlayerId { get; }
        /// <summary>Accessor for channelUri </summary>
        [Preserve]
        public string ChannelUri { get; }
        string PathAndQueryParams;

        /// <summary>
        /// JoinChannelV1 Request Object.
        /// This route verifies that a UAS token passed entitlement and sanction checks in UGG
        /// </summary>
        /// <param name="environmentId">The environment id</param>
        /// <param name="projectId">The project id</param>
        ...
        [Preserve]
        public JoinChannelV1Request(string environmentId, string projectId, string playerId, string channelUri)
        {
            EnvironmentId = environmentId;
            ...
            PathAndQueryParams = $"/v1/projects/{projectId}/environments/{environmentId}/players/{playerId}/channels/{channelUri}/join-channel";
