...
namespace Unity.Services.Vivox
{
    internal class ChannelSession : IChannelSession
    {
        ...
        private void HandleSessionDeleteMessage(vx_evt_base_t eventMessage)
        {
            ...
            OnSessionDeleteMessage(new VivoxMessage(message));
        }

        protected virtual void OnSessionDeleteMessage(VivoxMessage e)
        {
            EventHandler<VivoxMessage> handler = MessageDeleted;
        ...
        private void HandleSessionEditMessage(vx_evt_base_t eventMessage)
        {
            ...
            OnSessionEditMessage(new VivoxMessage(message));
        }

        protected virtual void OnSessionEditMessage(VivoxMessage e)
        {
            EventHandler<VivoxMessage> handler = MessageEdited;
            handler?.Invoke(this, e);
        }
